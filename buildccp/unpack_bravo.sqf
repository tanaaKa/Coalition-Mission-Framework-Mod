...
[5,_pos,{
	...
	_constructAction = ["constructCCP","Construct","",{_target execVM "scripts\buildccp\construct_bravo.sqf";},{true},{},_site] call ace_interact_menu_fnc_createAction;  
	...
	_packupAction = ["packupCCP","Pack Up","",{_target execVM "scripts\buildccp\packup_bravo.sqf";},{true}] call ace_interact_menu_fnc_createAction;  
