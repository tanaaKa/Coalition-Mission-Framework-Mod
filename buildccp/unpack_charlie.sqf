...
[5,_pos,{
	...
	_constructAction = ["constructCCP","Construct","",{_target execVM "x\cmf\addons\framework\buildccp\construct_charlie.sqf";},{true},{},_site] call ace_interact_menu_fnc_createAction;  
	...
	_packupAction = ["packupCCP","Pack Up","",{_target execVM "x\cmf\addons\framework\buildccp\packup_charlie.sqf";},{true}] call ace_interact_menu_fnc_createAction;  
