...
if (_playerClass in _medics) then {
	...
	if (_playerClass in ["BLU_PLM","BLU_2PLM","OPF_PLM","OPF_2PLM","IND_PLM","IND_2PLM"]) then {
		tnk_add_med_mo = {
			//Assign
			FH_Unpack_Action = ["unpackCCP","Unpack Field Hospital","",{[] execVM "scripts\buildccp\unpack_platoon.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	...
	if (_playerClass in ["BLU_ASLM","OPF_ASLM","IND_ASLM"]) then {
		tnk_add_med_a = {
			//Assign
			CCP_Unpack_Action_A = ["unpackCCP","Unpack CCP","",{[] execVM "scripts\buildccp\unpack_alpha.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	...
	if (_playerClass in ["BLU_BSLM","OPF_BSLM","IND_BSLM"]) then {
		tnk_add_med_b = {
			//Assign
			CCP_Unpack_Action_B = ["unpackCCP","Unpack CCP","",{[] execVM "scripts\buildccp\unpack_bravo.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	...
	if (_playerClass in ["BLU_CSLM","OPF_CSLM","IND_CSLM"]) then {
		tnk_add_med_c = {
			//Assign
			CCP_Unpack_Action_C = ["unpackCCP","Unpack CCP","",{[] execVM "scripts\buildccp\unpack_charlie.sqf";},{true}] call ace_interact_menu_fnc_createAction;
	...
	if (_playerClass in ["BLU_DSLM","OPF_DSLM","IND_DSLM"]) then {
		tnk_add_med_d = {
			//Assign
			CCP_Unpack_Action_D = ["unpackCCP","Unpack CCP","",{[] execVM "scripts\buildccp\unpack_delta.sqf";},{true}] call ace_interact_menu_fnc_createAction;
