...
#ifdef CAMO_UNIFORM
#else
#define CAMO_UNIFORM "U_O_CombatUniform_oucamo"
#endif
#ifdef CAMO_VEST
#else
#define CAMO_VEST "V_HarnessO_gry","V_Chestrig_blk","V_HarnessOGL_gry"
#endif
#ifdef CAMO_BACKPACK
#else
#define CAMO_BACKPACK "B_FieldPack_oucamo_Medic"
#endif
#ifdef CAMO_HEADGEAR
#else
#define CAMO_HEADGEAR "H_HelmetO_oucamo","H_HelmetLeaderO_oucamo"
#endif
// Rifle
#ifdef RIFLE
#else
