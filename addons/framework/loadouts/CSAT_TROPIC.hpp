...
#ifdef CAMO_VEST
#else
#define CAMO_VEST "V_Chestrig_oli","V_HarnessOGL_ghex_F","V_HarnessO_ghex_F"
#endif
#ifdef CAMO_BACKPACK
#else
#define CAMO_BACKPACK "B_FieldPack_ghex_OTMedic_F","B_FieldPack_oli"
#endif
#ifdef CAMO_HEADGEAR
#else
#define CAMO_HEADGEAR "H_HelmetO_ghex_F","H_HelmetLeaderO_ghex_F","H_HelmetSpecO_ghex_F"
#endif
// Rifle
#ifdef RIFLE
#else
#define RIFLE "arifle_CTAR_blk_ACO_Pointer_F"
#endif
#ifdef RIFLE_MAG
#else
#define RIFLE_MAG "30Rnd_580x42_Mag_F:6", "30Rnd_580x42_Mag_Tracer_F:4"
#endif
...
#ifdef GLRIFLE
#else
#define GLRIFLE "arifle_CTAR_GL_blk_ACO_F"
#endif
#ifdef GLRIFLE_MAG
#else
#define GLRIFLE_MAG "30Rnd_580x42_Mag_F:6", "30Rnd_580x42_Mag_Tracer_F:4"
#endif
...
#ifdef CARBINE
#else
#define CARBINE "arifle_CTAR_blk_ACO_Pointer_F"
#endif
#ifdef CARBINE_MAG
#else
#define CARBINE_MAG "30Rnd_580x42_Mag_F:6", "30Rnd_580x42_Mag_Tracer_F:4"
#endif
// AR
#ifdef AR
#else
...
#ifdef HAT
#else
#define HAT "launch_O_Titan_short_ghex_F"
#endif
#ifdef HAT_MAG
#else
...
#ifdef SNIPER
#else
#define SNIPER "srifle_DMR_07_blk_DMS_F"
#endif
#ifdef SNIPER_MAG
#else
...
#ifdef SPOTTER
#else
#define SPOTTER "arifle_CTAR_blk_ARCO_Pointer_F"
#endif
#ifdef SPOTTER_MAG
#else
#define SPOTTER_MAG "30Rnd_580x42_Mag_F:6", "30Rnd_580x42_Mag_Tracer_F:4"
#endif
...
#ifdef CREW_HEADGEAR
#else
#define CREW_HEADGEAR "H_HelmetCrew_O_ghex_F"
#endif
// Pilot Uniform
#ifdef PILOT_UNIFORM
#else
...
#ifdef NODS
#else
#define NODS "O_NVGoggles_ghex_F"
#endif
