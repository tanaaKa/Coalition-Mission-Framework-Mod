...
#ifdef CAMO_UNIFORM
#else
#define CAMO_UNIFORM "CUP_U_B_GER_Tropentarn_2","CUP_U_B_GER_Tropentarn_6","CUP_U_B_GER_Tropentarn_1"
#endif
#ifdef CAMO_VEST
#else
#define CAMO_VEST "CUP_V_B_GER_PVest_Trop_RFL","CUP_V_B_GER_PVest_Trop_RFL_LT","CUP_V_B_GER_PVest_Trop_Gren","CUP_V_B_GER_PVest_Trop_MG_LT","CUP_V_B_GER_PVest_Trop_Med_LT","CUP_V_B_GER_PVest_Trop_TL"
#endif
#ifdef CAMO_BACKPACK
#else
#define CAMO_BACKPACK "CUP_B_GER_Backpack_PZF","CUP_B_GER_Backpack_AT","CUP_B_GER_Backpack_GL","CUP_B_GER_Backpack_MG3","CUP_B_GER_Backpack_Medic"
#endif
#ifdef CAMO_HEADGEAR
#else
#define CAMO_HEADGEAR "CUP_H_Ger_M92_Cover_Trop","CUP_H_Ger_M92_Cover_Trop_GG_CF","CUP_H_Ger_M92_Cover_Trop_GG_CB","CUP_H_Ger_M92_Cover_Trop_GG"
#endif
// Rifle
#ifdef RIFLE
#else
...
#ifdef SPOTTER_MAG
#else
#define SPOTTER_MAG "CUP_30Rnd_TE1_Red_Tracer_556x45_G36:10"
#endif
#ifdef SPOTTER_ATTACHMENTS
#else
#define SPOTTER_ATTACHMENTS "CUP_acc_ANPEQ_15_Top_Flashlight_Black_L", "cup_optic_g36optics_holo", "CUP_Bipod_G36"
#endif
// SMG
#ifdef SMG
#else
...
#ifdef GOG
#else
#define GOG "CUP_PMC_Facewrap_Black","CUP_G_Oakleys_Drk","CUP_G_Oakleys_Embr","CUP_G_PMC_Facewrap_Black_Glasses_Dark","CUP_G_PMC_Facewrap_Black_Glasses_Ember"
#endif
#ifdef NODS
#else
