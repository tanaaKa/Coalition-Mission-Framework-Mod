...
[13,_site,{
	...
	_hintString = format ["The Bravo CCP has been established at GR#%1 by %2",_grid,_name]; // Predefine hint
	...
	if (isClass(configFile >> "CfgPatches" >> "kat_main")) then 
	{
		...
		_ccp addItemCargoGlobal ["kat_amiodarone", 10];
		_ccp addItemCargoGlobal ["kat_atropine", 10];
		_ccp addItemCargoGlobal ["kat_TXA", 10];
		_ccp addItemCargoGlobal ["kat_Carbonate", 2];
		_ccp addItemCargoGlobal ["kat_Painkiller", 2];
		_ccp addItemCargoGlobal ["kat_retractor", 2];
		_ccp addItemCargoGlobal ["kat_scalpel", 2;
		_ccp addItemCargoGlobal ["kat_nalbuphine", 5];
		_ccp addItemCargoGlobal ["kat_lorazepam", 5];
		_ccp addItemCargoGlobal ["kat_flumazenil", 6];
		_ccp addItemCargoGlobal ["kat_kat_fentanyl", 5];
		_ccp addItemCargoGlobal ["kat_etomidate", 10];
		_ccp addItemCargoGlobal ["kat_EACA", 10];
		_ccp addItemCargoGlobal ["kat_vacuum", 2];
		_ccp addItemCargoGlobal ["kat_clamp", 4];
		_ccp addItemCargoGlobal ["kat_plate", 4];
