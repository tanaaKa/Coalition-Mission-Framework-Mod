...
if ((player distance _pos)>6) exitWith {
	_errorString = "Desired hospital position too far from player. Look at a closer position.";
	hint _errorString;
};
...
[5,_pos,{
	...
	_constructAction = ["constructCCP","Construct","",{_target execVM "x\cmf\addons\framework\buildccp\construct_platoon.sqf";},{true},{},_site] call ace_interact_menu_fnc_createAction;  
	...
	_packupAction = ["packupCCP","Pack Up","",{_target execVM "x\cmf\addons\framework\buildccp\packup_platoon.sqf";},{true}] call ace_interact_menu_fnc_createAction;  
...
}, {}, "Unpacking FH..."] call ace_common_fnc_progressBar;
